...
let output = document.querySelector(".heading2");
...
function calculate() {
  ...
  if (inputData !== "") {
    ...
    if (day === currentDate && month === currentMonth) {
      ...
      output.innerHTML = `Congratulations!! Today is your birthday! You are <span class="year">${birthday}</span> Years Old.<br>Enjoy your day!</br> `;
    } else {
